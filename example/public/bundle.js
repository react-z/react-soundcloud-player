	...
	var Player = function (_Component) {
	  ...
	  _createClass(Player, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('div', { className: 'player player__track--active' }, _react2.default.createElement('audio', { id: 'audio', ref: 'audio', src: streamUrl }), _react2.default.createElement('div', { className: 'player__control', onClick: this.togglePlay.bind(this) }, _react2.default.createElement('svg', { className: iconClass, x: '0px', y: '0px', viewBox: '0 0 40 40', 'data-reactid': '.23fudc7q4g0.1.5:0.1.0.$18471/=1$18471.0.1.0.0.2.0.0.1.0.0' }, _react2.default.createElement('path', { 'class': 'button-circle', d: 'M20,1c10.5,0,19,8.5,19,19s-8.5,19-19,19S1,30.5,1,20S9.5,1,20,1 M20,0C9,0,0,9,0,20s9,20,20,20s20-9,20-20S31,0,20,0L20,0z', 'data-reactid': '.23fudc7q4g0.1.5:0.1.0.$18471/=1$18471.0.1.0.0.2.0.0.1.0.0.0' }), _react2.default.createElement('g', { 'class': 'play-icon icon', 'data-reactid': '.23fudc7q4g0.1.5:0.1.0.$18471/=1$18471.0.1.0.0.2.0.0.1.0.0.1' }, _react2.default.createElement('path', { d: 'M16.9,12.4c-0.2-0.1-0.5-0.2-0.8,0c-0.2,0.1-0.4,0.4-0.4,0.7v14c0,0.3,0.1,0.5,0.4,0.7c0.1,0.1,0.2,0.1,0.4,0.1c0.1,0,0.3,0,0.4-0.1l11-7c0.2-0.1,0.3-0.4,0.3-0.6s-0.1-0.5-0.3-0.6L16.9,12.4z', 'data-reactid': '.23fudc7q4g0.1.5:0.1.0.$18471/=1$18471.0.1.0.0.2.0.0.1.0.0.1.0' })))), _react2.default.createElement('div', { className: 'player__display' }, _react2.default.createElement('div', null, _react2.default.createElement('h4', null, title), _react2.default.createElement('span', { className: 'player__soundcloud' }, _react2.default.createElement('span', null, 'Via '), _react2.default.createElement('a', { href: '', rel: 'nofollow', target: '_blank' }, 'SoundCloud'))), _react2.default.createElement('div', { className: 'player__progress' }, _react2.default.createElement('span', { className: 'player__progress__time' }, current_time), _react2.default.createElement('span', { className: 'player__progress__bar' }, _react2.default.createElement('span', { className: 'player__progress__bar--container' }, _react2.default.createElement('span', { className: 'player__progress__bar--percent', style: percent }))), _react2.default.createElement('span', { className: 'player__progress__time' }, duration))));
	    }
	  }]);
